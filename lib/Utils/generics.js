...
// const generateMessageID = () => 'F4YK4L' + (0, crypto_1.randomBytes)(6).toString('hex').toUpperCase();
const generateMessageID = () => crypto_1.randomBytes(10).toString('hex').toUpperCase() + crypto_1.randomBytes(6).toString('hex').toUpperCase();
